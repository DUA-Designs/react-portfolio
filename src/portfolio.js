...
import  {dicegame,weatherAppDemo,quizAppDemo,DD,Pic1,Pic2,Pic3,Pic4,Pic5,Pic6,infotrixs, Roxiler, Roxiler1, Roxiler2, Roxiler3} from './imageComponents';
 ...
 const projects=[
  {icon:<i class="fa-solid fa-table-columns"></i>,git:"https://github.com/DUA-Designs/roxilerBackend",demo:"https://roxilerfront-end.onrender.com/",completion:"February 2024",name:"Transaction Dashboard",desc:"Functional sales dashboard featuring table for showing the items, section for Statistics and barChart for price Ranges. This project is based on MERN Stack and it is coding challenge given to me by  GEEKS-FOR-GEEKS for ROXILER company recruitment.",carousel:[Roxiler,Roxiler1,Roxiler2,Roxiler3]},
    ...
    <nav className="navbar navbar-expand-lg position-fixed    z-3 "id="mrNav">
      ...
      <div className="p-2  text-center   rounded"  >
        ...
        {projects.map((item)=> item.desc? 
                                             ...
                                             <div className="carousel-inner">
                                               ...
                                               {item.carousel.map((carouselItem,caroIndex)=>{
                                                if(caroIndex>0){
                                                 ...
                                                 <img src={carouselItem} class="d-block w-100 border rounded" alt="..."/>
                                               </div>);
                                               }
                                               else{
                                                return "";
                                  ...
                                  <div className="col-lg-4 col-md-6 col-sm-6 col-xs-10 my-2 position-relative " id="box">
